...
public class CheckerPanel extends JPanel implements MouseMotionListener, MouseListener{
  ...
  // uses the serializable class converts an instance of a class into bytes 
	private static final long serialVersionUID = 1L;

	public Checker checker;
	public Colision col;

  //  declares boolean variables to false in order to highlight each piece 
  ...
  // moves each piece to a new square if its ture 
  ...
  // uses x and y coordinates and assignes them to a certain spot on the board 
	public int X11=87; 
  ...
  // sets each variable to a coordinate
	public CheckerPanel(){
		checker = new Checker();
		col = new Colision();
	...
	public void paint(Graphics g){
		...
		//sets color of the board
		g.setColor(Color.black);
		g.fillRect(0, 0, 660, 700);
		g.setColor(Color.lightGray);
		g.fillRect(660, 0, 700, 700);		
		g.setColor(Color.white);
    // g.fill Rect fills each individual rectangel , you have the ex coordinate, y coordinate then the width and height of each
		...
		//set the color of the pieces and fills each oval 
	...
	@Override
  // if statements checks whether the user cicks on elements on the program. When certain elements are clickes the boolean is set to true and updates the program
