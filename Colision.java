...
public class Colision {
	...
	// handles collision detection for 32 squares and 24 checkers 

  //stores x and y coordinates of the balls or pieces 
  public int ball11X;
	public int ball11Y;
	public int ball13X=246; //246
	public int ball13Y=33; //33
	public int ball15X=440; // 440
	public int ball15Y=33; //33
  ...
  // stores x and y coordinates of the rectangle 
	...
	public Colision(){
		ball11X=88;
		ball11Y=33;
		//set x and y coordinates for the first ball and initalizes the rectangles for the squares and checkers 
